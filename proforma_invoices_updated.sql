-- SQL Script untuk update tabel proforma_invoices
-- Menambahkan field untuk input manual

ALTER TABLE `proforma_invoices` 
ADD COLUMN `volume_per_day` decimal(10,3) NOT NULL AFTER `total_volume`,
ADD COLUMN `price_per_sm3` decimal(12,2) NOT NULL AFTER `volume_per_day`,
ADD COLUMN `total_days` int(11) NOT NULL AFTER `price_per_sm3`;

-- Update SQL script lengkap untuk membuat tabel proforma_invoices dengan field baru
